...
GitHub에서는 사이즈 조절 기능이 없기 때문에 `<img width="" height=""></img>`를 이용합니다.
```
...
## 11. 표(Table)
|(vertical bar) 기호를 통해 테이블을 표현 가능합니다. (가장 좌측, 우측 생략 가능)   
헤더와 셀을 구분할 때 3개 이상의 -(하이픈, 대시)가 필요 합니다.   
: (콜론) 기호를 통해 정렬할 수 있습니다
```
